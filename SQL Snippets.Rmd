...
off of various databases.  The schema, some of the logic, the names, and other pieces of information have been changed so this work is non-functional, for example only.
